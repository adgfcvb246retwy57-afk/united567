            ...
            return (
              ...
              >
                {isSelectedAndLoading ? (
                  <Loader2 className="w-6 h-6 text-[#002586] shrink-0 mt-0.5 animate-spin" />
                ) : (
                  <Icon className="w-6 h-6 text-[#002586] shrink-0 mt-0.5" />
                )}
                <div>
                  <p className="text-[#002586] font-medium">{title}</p>
