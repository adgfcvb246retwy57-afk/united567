    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="max-w-2xl px-4 py-10 mb-[270px] mx-auto md:mx-0 md:ml-[60px] flex-1">
        <div className="flex items-center gap-2 mb-2">
          ...
          <button
            type="button"
            className="text-[#002586] hover:underline flex items-center gap-1"
            aria-label="Help"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start gap-2">
            ...
            <label htmlFor="privacy" className="text-sm text-gray-700 cursor-pointer select-none">
              ...
              <a href="#" className="text-[#002586] hover:underline font-medium">Alight Privacy Policy.</a>
            </label>
          </div>
          ...
          <div className="flex gap-3 pt-2">
            <Button
              ...
              className="bg-[#002586] hover:bg-[#001f6b] text-white rounded-md h-9 px-5 text-sm font-medium disabled:bg-gray-300 disabled:text-gray-500 disabled:pointer-events-none"
            >
